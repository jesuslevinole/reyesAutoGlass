...
export const WorkOrderPage: React.FC = () => {
  ...
  // Estado para deshabilitar el botón "Guardar" mientras se guarda (anti doble-clic).
  const [isSaving, setIsSaving] = useState(false);
  // Bandera inmediata (no espera al re-render) que evita reentrar a handleSave.
  ...
  const handleSave = async () => {
    // Guard anti doble-clic: si ya hay un guardado en curso, ignora el clic.
    ...
    // Bloquea reentradas de inmediato (el ref no espera al re-render).
  ...
  // --- ELIMINAR ORDEN (borra cabecera + partes en ambas colecciones) ---
