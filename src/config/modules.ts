...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'type', label: 'Type', type: 'enum', options: ['Parts', 'Services', 'Molding'], inList: true, section: 'general' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'alternative_phone', label: 'Alternative phone', type: 'phone', altKeys: ['alternativePhone'] },
      { key: 'email', label: 'Email', type: 'email', inList: true },
      { key: 'address', label: 'Address', type: 'longtext', inList: true },
    ],
  },
  {
    id: 'team',
